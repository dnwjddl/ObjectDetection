...
class YOLOv3(nn.Module):
    ...
    def forward(self, x, targets = None, labels = None):
        ...
        output1, loss1 = self.anchor1(featureMap1, targets, labels)
        ...
        output2, loss2 = self.anchor2(featureMap2, targets, labels)
        ...
        output3, loss3 = self.anchor3(featureMap3, targets,labels)
